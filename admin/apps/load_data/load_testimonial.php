...
$query = "select * from rk_blog WHERE type = 2";
...
?>
 <div class="box-body table-responsive no-padding">
	...
	<table class="table table-hover">
	 ...
	 <?php 		
		global $mysqli;
		$stmt = $mysqli->prepare("SELECT id, title, img1 from rk_blog WHERE type = 2
        ...
        $stmt->bind_result($id, $btitle, $img1);
				...
				while ($stmt->fetch()) { ?>               
                            <tr>
								...
								<a href="update_testimonial/<?php echo $id; ?>" class="btn btn-success btn-raised btn-xs" data-toggle="tooltip" data-placement="top" title="Edit Information" ><i class="fa fa-pencil"></i><div class="ripple-container"></div></a>
