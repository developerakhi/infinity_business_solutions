...
$query = "select * from rk_blog WHERE type = 3";
...
?>
 <div class="box-body table-responsive no-padding">
	...
	<table class="table table-hover">
	 ...
	 <?php 		
		global $mysqli;
		$stmt = $mysqli->prepare("SELECT id, title, sort_desc from rk_blog WHERE type = 3
    	    ORDER BY id DESC limit ".mysqli_real_escape_string($mysqli,$start).",$recordsPerPage");
        $stmt->execute();    // Execute the prepared query.
        // get variables from result.
        $stmt->bind_result($id, $btitle, $sort_desc);
				...
				while ($stmt->fetch()) { ?>               
                            <tr>
								...
								<a href="update_video/<?php echo $id; ?>" class="btn btn-success btn-raised btn-xs" data-toggle="tooltip" data-placement="top" title="Edit Information" ><i class="fa fa-pencil"></i><div class="ripple-container"></div></a>
