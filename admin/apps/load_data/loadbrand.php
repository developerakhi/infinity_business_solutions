...
$query="select img2 from sd_brands order by id DESC
 ...
 <div class="box-body table-responsive no-padding">
	...
	<table class="table table-hover">
	 ...
	 <?php 		
        ...
        $stmt->bind_result($id, $title, $img1, $img2);
			...
			while ($stmt->fetch()) { ?>               
                            <tr>
								...
								<a href="update_brand/<?php echo $id; ?>" class="btn btn-success btn-raised btn-xs" data-toggle="tooltip" data-placement="top" title="Edit Information" ><i class="fa fa-pencil"></i><div class="ripple-container"></div></a>
                                
                              <a href="apps/bin_cat/delete_brand.php?actionID=view_all_brand&BrndID=<?php echo $id; ?>" class="btn btn-danger btn-raised btn-xs" data-toggle="tooltip" data-placement="top" title="Delete This Row" onClick="return confirm('Are you sure to Delete this Row?')"><i class="fa fa-close"></i><div class="ripple-container"></div></a>
							</td>
                            </tr>
   						 	 <?php }
							   $stmt->close();
