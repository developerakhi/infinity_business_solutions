...
<!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-md-12">
        <a href="all_services" class="btn btn-lg btn-danger btn-raised btn-label"><i class="fa fa-newspaper-o" aria-hidden="true"></i> &nbsp; Service List </a>
            <div class="box box-primary">
                <div class="box-header with-border">
					<h3 class="box-title">Add Service</h3>
				</div>
				<form action="apps/services/service_insert_code.php" enctype="multipart/form-data"  method="POST">
					  <div class="box-body">
